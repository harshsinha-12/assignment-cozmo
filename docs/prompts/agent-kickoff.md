...
- If `docs/takehome.md` is a stub, planning/fixture mode only. It is **not** a stub. Execute the top unblocked item in `TASKS.md` (currently T14). Target every official gate; do not skip photos/video. Cuts only as `docs/cut-later.md`.
