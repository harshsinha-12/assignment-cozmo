...
- If `docs/takehome.md` is a stub, planning/fixture mode only. It is **not** a stub. Execute the top unblocked engineering item in `TASKS.md` (currently T6). Target every official gate; do not skip photos/video. Cuts only as `docs/cut-later.md`.
