...
**Code:** T12 extend `docs/schemas/floorplan.schema.json` (required intervals, damage, concealed_flags, scope) → T13 CLI stub → T14 red eval for official gates. Then T6 LiDAR, T15 SVG, T9 stitch+ablation, T7 video, T8 photos, T16 agent.
