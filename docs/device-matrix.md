...
| iPhone Pro / Pro Max with LiDAR | yes | yes | yes | JPEG; MOV/MP4 ingest; T21e exports a job ZIP with RoomPlan JSON plus Record3D-compatible `.r3d` from ARKit depth; `.r3d` emits partial metric IR | not measured |
| Harsh's iPhone 17 Pro | yes | yes | yes | Three real `.r3d` room captures produce partial rooms/walls/opening candidates; photos/video partial; T21g device install pending | not measured |
