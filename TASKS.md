...
**T7b:** harden the video adapter for multiple walkthrough files and apply their
display rotation before feature work. Preserve per-video room identity and emit
auditable frame diagnostics; do not infer metric scale from RGB alone.
